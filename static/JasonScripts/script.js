...
//   private static JLabel label = new JLabel();
  ...
  drawArrowHeads (p1, p2, direction) {
    if (this.getStartArrowHead() !== undefined) { this.getStartArrowHead().drawMethod(p1, p2, direction, true) }

    if (this.getEndArrowHead().drawMethod !== undefined) { this.getEndArrowHead().drawMethod(p1, p2, direction, false) }
  }
...
class CallEdge extends SegmentedLineEdge {
  ...
  setSignal (newValue) {
    ...
    } else { this.setEndArrowHead(ArrowHead.V) }
  }
